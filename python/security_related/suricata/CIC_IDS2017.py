...
def process_cic_ids2017_logs(pcap_file):
    ...
    df_suricata = df_suricata.drop_duplicates(['src_ip', 'dest_ip', 'src_port', 'dest_port', 'proto'])


    df_merged = pd.merge(df_gt, df_suricata, how='inner', on=['src_ip', 'dest_ip', 'src_port', 'dest_port', 'proto'],suffixes=('_gt', '_suricata'))
